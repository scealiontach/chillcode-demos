 ...
 */
$databases['default']['default'] = array(
	'database' => getenv('service_drupaldb_dbname'),
	'username' => getenv('service_drupaldb_user'),
	'password' => getenv('service_drupaldb_password'),
	'host' => getenv('service_drupaldb_address'),
 ...
 * @endcode
 */
$settings['hash_salt'] = 'YOU_SHOULD_CHANGE_THIS_VALUE';
